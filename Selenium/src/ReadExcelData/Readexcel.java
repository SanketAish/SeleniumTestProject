...
public class Readexcel extends SeleniumUtils {
	...
	public String readTestData(String fileName,String sheetName,int rowNum,int cellNum) throws IOException {
				//1. File location
				FileInputStream fis=new FileInputStream("D:\\Selenium\\Testdata\\Excel\\Textdata1.xlsx");
	...
	public void getAppData() throws IOException {
		appUrl=readTestData("D:\\Selenium\\Testdata\\Excel\\Textdata1.xlsx", "Sheet1", 1,0);
		userName=readTestData("D:\\Selenium\\Testdata\\Excel\\Textdata1.xlsx", "Sheet1", 1,1);
		password=readTestData("D:\\Selenium\\Testdata\\Excel\\Textdata1.xlsx", "Sheet1", 1,2);
	//	expectedTitle=readTestData("D:\\Selenium\\Testdata\\Excel\\Textdata1.xlsx", "Sheet1", 1,3);
	}
	@BeforeMethod
	public void setUp() {
