package ParameterizationAndParellel;
...
public class Parameterization extends SeleniumUtils {
	...
	public void testLoginOfVtiger(String browser,String username, String password) {
		WebDriver driver=setUp(browser, "https://demo.vtiger.com/vtigercrm/index.php");
